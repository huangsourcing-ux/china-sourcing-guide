...
date: June 22, 2026
source: https://www.huangsourcing.com#efiling-checklist
topics: []
---

# CPSC eFiling for China Imports in 2026

> Published: June 22, 2026
> Original: https://www.huangsourcing.com#efiling-checklist
...
- [CPSC - eFiling FAQ](https://www.huangsourcing.comhttps://www.cpsc.gov/FAQ/eFiling-Frequently-Asked-Questions-FAQ) — CPSC FAQ covering Full PGA Message Sets, Reference PGA Message Sets, Product Registry identifiers, implementation dates, and Section 321 treatment.
- [CPSC - eFiling document library](https://www.huangsourcing.comhttps://www.cpsc.gov/eFiling-Document-Library) — Official library for Product Registry, CSV upload, API, CATAIR, HTS list, citation, testing-exception, exclusion, and disclaim guidance.
- [CPSC - HTS list and eFiling guidance](https://www.huangsourcing.comhttps://www.cpsc.gov/s3fs-public/CPSC-Guidance-and-HTS-List-for-Filing-of-Electronic-Certificates-6B-Cleared.pdf) — Official January 2026 PDF noting that the HTS list is guidance, not an all-encompassing list of every code where electronic certificates may be required.
