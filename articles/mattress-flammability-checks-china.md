...
- [QC inspection in China](https://www.huangsourcing.com/qc-inspection-china) — Compare buyer-approved construction, labels, packages, quantities, and evidence while the actual goods remain accessible.
- [Before balance-payment check](https://www.huangsourcing.com/before-balance-payment-qc-china) — Hold, correct, re-inspect, or release a named lot before money and goods move.
